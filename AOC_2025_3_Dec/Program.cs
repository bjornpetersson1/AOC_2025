...
for (int i = 0; i < inputs.Length; i++)
{
    ...
    for (global::System.Int32 j = 9; j > 0 && !joltageDone; j--)
    {
        if (rest.Contains((char)('0' + j)) && rest.IndexOf((char)('0' + j)) < rest.Length - 11)
        {
            joltage += (char)('0' + j);
            ...
            {
                if (rest.Contains((char)('0' + k)) && rest.IndexOf((char)('0' + k)) < rest.Length - 10)
                {
                    joltage += (char)('0' + k);
                    ...
                    {
                        if (rest.Contains((char)('0' + l)) && rest.IndexOf((char)('0' + l)) < rest.Length - 9)
                        {
                            joltage += (char)('0' + l);
                            ...
                            {
                                if (rest.Contains((char)('0' + m)) && rest.IndexOf((char)('0' + m)) < rest.Length - 8)
                                {
                                    joltage += (char)('0' + m);
                                    ...
                                    {
                                        if (rest.Contains((char)('0' + n)) && rest.IndexOf((char)('0' + n)) < rest.Length - 7)
                                        {
                                            joltage += (char)('0' + n);
                                            ...
                                            {
                                                if (rest.Contains((char)('0' + o)) && rest.IndexOf((char)('0' + o)) < rest.Length - 6)
                                                {
                                                    joltage += (char)('0' + o);
                                                    ...
                                                    {
                                                        if (rest.Contains((char)('0' + p)) && rest.IndexOf((char)('0' + p)) < rest.Length - 5)
                                                        {
                                                            joltage += (char)('0' + p);
                                                            ...
                                                            {
                                                                if (rest.Contains((char)('0' + q)) && rest.IndexOf((char)('0' + q)) < rest.Length - 4)
                                                                {
                                                                    joltage += (char)('0' + q);
                                                                    ...
                                                                    {
                                                                        if (rest.Contains((char)('0' + r)) && rest.IndexOf((char)('0' + r)) < rest.Length - 3)
                                                                        {
                                                                            joltage += (char)('0' + r);
                                                                            ...
                                                                            {
                                                                                if (rest.Contains((char)('0' + s)) && rest.IndexOf((char)('0' + s)) < rest.Length - 2)
                                                                                {
                                                                                    joltage += (char)('0' + s);
                                                                                    ...
                                                                                    {
                                                                                        if (rest.Contains((char)('0' + t)) && rest.IndexOf((char)('0' + t)) < rest.Length - 1)
                                                                                        {
                                                                                            joltage += (char)('0' + t);
